...
2. **If the model has any moving parts, load the `assembly` group and `/home/gregoire/.agents/skills/forgecad/docs/guides/joint-design.md` upfront** — do not defer the kinematic structure to a refactor pass.
...
4. If any two parts are intended to touch or mate in the final model, load `/home/gregoire/.agents/skills/forgecad/docs/guides/positioning.md` immediately and default to connectors + `matchTo()`.
...
- `/home/gregoire/.agents/skills/forgecad/docs/API/core/concepts.md`
- `/home/gregoire/.agents/skills/forgecad/docs/generated/runtime-names.md`
- `/home/gregoire/.agents/skills/forgecad/docs/generated/core.md`
...
- `/home/gregoire/.agents/skills/forgecad/docs/guides/coordinate-system.md`
- `/home/gregoire/.agents/skills/forgecad/docs/guides/positioning.md`

### 3. Sketch APIs

2D construction, transforms, booleans, paths, on-face sketching, extrusion, anchors, text, regions.

- `/home/gregoire/.agents/skills/forgecad/docs/generated/sketch.md`
...
- `/home/gregoire/.agents/skills/forgecad/docs/guides/surface-members.md`
- `/home/gregoire/.agents/skills/forgecad/docs/generated/curves.md`
...
- `/home/gregoire/.agents/skills/forgecad/docs/generated/assembly.md`

### 6. Sheet Metal (for bent parts, K-factor, flat patterns)

Bend operations, flat pattern unfolding, K-factor configuration.

- `/home/gregoire/.agents/skills/forgecad/docs/generated/sheet-metal.md`
...
- `/home/gregoire/.agents/skills/forgecad/docs/generated/output.md`
...
- `/home/gregoire/.agents/skills/forgecad/docs/generated/lib.md`
- `/home/gregoire/.agents/skills/forgecad/docs/generated/wood.md`
...
- `/home/gregoire/.agents/skills/forgecad/docs/generated/viewport.md`

### 10. Recipes and Debugging (for patterns and troubleshooting)

Modeling patterns, debugging tactics, copyable snippets.

- `/home/gregoire/.agents/skills/forgecad/docs/guides/scene-presentation.md`
- `/home/gregoire/.agents/skills/forgecad/docs/guides/joint-design.md`

### 11. CLI (for validation/render/export tasks)

Test-run, export pipelines, debug flags.

- `/home/gregoire/.agents/skills/forgecad/docs/CLI.md`
- `/home/gregoire/.agents/skills/forgecad/docs/guides/inspection-bundles.md`
...
- `/home/gregoire/.agents/skills/forgecad/docs/generated/sdf.md`
